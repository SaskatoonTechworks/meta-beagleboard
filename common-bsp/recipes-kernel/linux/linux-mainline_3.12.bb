...
SRC_URI += " \
	...
	file://audio/0001-ASoC-davinci-evm-Move-sysclk-logic-away-from-evm_hw_.patch \
	file://audio/0002-ASoC-davinci-evm-Add-device-tree-binding.patch \
	file://audio/0003-ASoC-davinci-mcasp-Add-DMA-register-locations-to-DT.patch \
	file://audio/0004-ASoC-davinci-mcasp-Extract-DMA-channels-directly-fro.patch \
	file://audio/0005-ASoC-davinci-mcasp-Interrupts-property-to-optional-a.patch \
	file://audio/0006-ASoC-davinci-Add-support-for-AM33xx-SoC-Audio.patch \
	file://audio/0007-ASoC-davinci-mcasp-Remove-redundant-num-serializer-D.patch \
	file://audio/0008-ASoC-davinci-evm-Add-named-clock-reference-to-DT-bin.patch \
	file://audio/0009-ASoC-davinci-evm-HDMI-audio-support-for-TDA998x-trou.patch \
	file://audio/0010-ASoC-hdmi-codec-Add-devicetree-binding-with-document.patch \
	file://audio/0011-ASoC-hdmi-codec-Add-SNDRV_PCM_FMTBIT_32_LE-playback-.patch \
	file://audio/0012-ASoC-davinci-HDMI-audio-build-for-AM33XX-and-TDA998x.patch \
	file://audio/0013-Audio-McASP-Add-McASP-Device-Tree-Bindings.patch \
	file://audio/0014-ASoc-McASP-Lift-Reset-on-CLK-Dividers-when-RX-TX.patch \
	file://audio/0015-ASoc-Davinci-EVM-Config-12MHz-CLK-for-AIC3x-Codec.patch \
	file://drm/0001-drm-tilcdc-Add-I2C-HDMI-audio-config-for-tda998x.patch \
	file://cpufreq/0001-ARM-OMAP3-do-not-register-non-dt-OPP-tables-for-devi.patch \
	file://cpufreq/0002-ARM-OMAP2-add-missing-lateinit-hook-for-calling-pm-l.patch \
	file://cpufreq/0003-ARM-OMAP3-use-cpu0-cpufreq-driver-in-device-tree-sup.patch \
	file://cpufreq/0004-ARM-dts-OMAP3-add-clock-nodes-for-CPU.patch \
	file://cpufreq/0005-hack-boneblack-enable-1Ghz-operation.patch \
